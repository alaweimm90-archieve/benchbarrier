                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleBillingDetailsChange('firstName', e.target.value)
                            }
                            className="mt-2 rounded-none"
                            placeholder="First name"
                          />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div>
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              handleBillingDetailsChange('postalCode', e.target.value)
                            }
                            className="mt-2 rounded-none"
                            placeholder="Postal code"
                          />
                ...
                {!paymentComplete ? (
                  <div className="space-y-6">
                    <div>
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          handlePaymentDetailsChange('cardholderName', e.target.value)
                        }
                        className="mt-2 rounded-none"
                  ...
                  <div className="text-center py-12">
                    ...
                    <p className="text-muted-foreground">
                      Thank you for your purchase. Your order confirmation has been sent to your
                      email.
                    </p>
                  </div>
                )}
