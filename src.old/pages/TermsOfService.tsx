          ...
          <div className="prose prose-lg max-w-none space-y-8">
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                agree to be bound by the terms and provision of this agreement. These Terms of
                Service govern your use of our website, products, and services.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                ...
                Jewelry Inc.'s website for personal, non-commercial transitory viewing only. This is
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                not responsible for lost, stolen, or damaged packages once they have been delivered
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed mb-4">
                We want you to be completely satisfied with your purchase. Returns and exchanges are
                accepted within 30 days of delivery, subject to the following conditions:
              </p>
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                warranty does not cover damage from normal wear, improper care, or accidents. Proper
                care instructions are provided with each purchase and on our website.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                governs your use of our website and services, to understand our practices regarding
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                of New York State, and you irrevocably submit to the exclusive jurisdiction of the
            ...
            <section>
              ...
              <p className="text-muted-foreground leading-relaxed">
                ...
                using this website, you are agreeing to be bound by the current version of these
                Terms of Service.
              </p>
            </section>
